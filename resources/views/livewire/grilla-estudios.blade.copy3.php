...
<body class="flex items-center justify-center">
	<div class="container">
		<table id="estudios" class="w-full flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5">
                ...
                @foreach ($paginator as $estudio)
                    <tr class="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
                        ...
                        @if(isset($estudio['00080030']['Value'][0]))
                            <td class="border-grey-light border hover:bg-gray-100 p-3">{{date("H:i", strtotime(substr($estudio['00080030']['Value'][0], 0, 2) . ":" . substr($estudio['00080030']['Value'][0], 2, 2)));}}</td>
                        @else
                            <td>-</td>
                        @endif
    ...
    #estudios {
            table-layout: fixed;
            width: 100%;
            border-collapse: collapse; /* Combina los bordes de las celdas para reducir el espaciado */
            border-spacing: 0; /* Establece el espaciado entre las celdas en 0 */
            padding: 0; /* Elimina cualquier padding en el contenedor de la tabla */
        }
        #estudios th,
        #estudios td {
            min-width: 100px; /* Ancho mínimo para las celdas (ajústalo según sea necesario) */
            white-space: normal; /* Permitir el salto de líneas */
            word-wrap: break-word; /* Permitir el salto de palabras */
            overflow: hidden;
            text-overflow: ellipsis;
            padding: 8px; /* Ajusta el padding según sea necesario para la mayoría de las celdas */
            border: 0px solid #ddd; /* Agrega bordes para mayor claridad, ajusta según tu diseño */
            text-align: left;
        }
